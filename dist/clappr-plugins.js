(function (global, factory) {
  ...
  var clickToPauseHTML = "<div class=\"icon-wrapper\">\n  <div class=\"play-button\"></div>\n  <div class=\"pause-button\"></div>\n</div>\n";

  var css_248z$8 = ".player-click-to-pause {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  position: absolute;\n  height: 100%;\n  width: 100%;\n  z-index: 4; }\n  .player-click-to-pause .icon-wrapper {\n    display: none;\n    opacity: 0.75;\n    transition: opacity 0.1s ease;\n    background-color: rgba(0, 0, 0, 0.4);\n    width: 150px;\n    height: 150px;\n    border-radius: 50%;\n    margin: 0; }\n  .player-click-to-pause .pause-button,\n  .player-click-to-pause .play-button {\n    display: none; }\n  .player-click-to-pause .icon-wrapper svg {\n    width: 150px;\n    height: 150px;\n    position: relative;\n    left: 10%;\n    padding: 12%; }\n    .player-click-to-pause .icon-wrapper svg path {\n      fill: #fff; }\n  .player-click-to-pause .pause-button svg {\n    left: 0; }\n  .player-click-to-pause .icon-wrapper[data-pause],\n  .player-click-to-pause .icon-wrapper[data-play] {\n    display: block; }\n  .player-click-to-pause .icon-wrapper[data-pause] .pause-button {\n    display: block; }\n  .player-click-to-pause .icon-wrapper[data-play] .play-button {\n    display: block; }\n";
  ...
  var ClickToPausePlugin = /*#__PURE__*/function (_UICorePlugin) {
    _inherits(ClickToPausePlugin, _UICorePlugin);
    ...
    _createClass(ClickToPausePlugin, [{
      ...
      value: function bindEvents() {
        this.listenTo(this.core, core.Events.CORE_ACTIVE_CONTAINER_CHANGED, this.onContainerChange);
      }
    }, {
      ...
      value: function onContainerChange() {
        ...
        this.listenTo(this.container, core.Events.CONTAINER_CLICK, this.onClick);
        this.listenTo(this.container, core.Events.CONTAINER_TAP, this.onTouch);
        this.listenTo(this.container, core.Events.CONTAINER_MEDIACONTROL_HIDE, this.hideIcon);
        this.listenTo(this.container, core.Events.CONTAINER_MEDIACONTROL_SHOW, this.showIcon);
        this.listenTo(this.container, core.Events.CONTAINER_PAUSE, this.showIcon);
        this.listenTo(this.container, core.Events.CONTAINER_PLAY, this.showIcon);
      }
    }, {
      key: "showIcon",
      ...
      value: function onTouch() {
        if (this.core.mediaControl.isVisible()) this.container.trigger(core.Events.CONTAINER_CLICK);else this.core.mediaControl.show();
      }
    }, {
      key: "pausable",
      value: function pausable() {
        return this.container.getPlaybackType() !== core.Playback.LIVE || this.container.isDvrEnabled();
      }
    }, {
      key: "settingsUpdate",
      value: function settingsUpdate() {
        var pointerEnabled = this.pausable();
        if (pointerEnabled === this.pointerEnabled) return;
        if (pointerEnabled) this.container.$el.addClass('pointer-enabled');else this.container.$el.removeClass('pointer-enabled');
      ...
      value: function render() {
        ...
        var style = core.Styler.getStyleFor(css_248z$8);
  ...
  var ClosedCaptions = /*#__PURE__*/function (_UICorePlugin) {
    ...
    _createClass(ClosedCaptions, [{
      ...
      value: function renderCcButton() {
        ...
        var style = core.Styler.getStyleFor(css_248z$7, {
  ...
  var DVRControls = /*#__PURE__*/function (_UICorePlugin) {
    ...
    _createClass(DVRControls, [{
      ...
      key: "render",
      value: function render() {
        var style = core.Styler.getStyleFor(css_248z$6, {
          baseUrl: this.options.baseUrl
        });
        this.$el.html(this.template({
  ...
  var ErrorScreen = /*#__PURE__*/function (_UICorePlugin) {
    ...
    _createClass(ErrorScreen, [{
      ...
      value: function render() {
        if (!this.err) return;
        var style = core.Styler.getStyleFor(css_248z$5, {
          baseUrl: this.options.baseUrl
        });
        this.$el.html(this.template({
  ...
  var Config = core.Utils.Config,
    ...
    formatTime$1 = core.Utils.formatTime,
  ...
  var MediaControl = /*#__PURE__*/function (_UICorePlugin) {
    ...
    _createClass(MediaControl, [{
      ...
      value: function render() {
        ...
        var style = core.Styler.getStyleFor(css_248z$4, {
          baseUrl: this.options.baseUrl
        });
        this.$el.append(style[0]);
  ...
  var formatTime = core.Utils.formatTime;
  var SeekTime = /*#__PURE__*/function (_UICorePlugin) {
    ...
    _createClass(SeekTime, [{
      ...
      key: "render",
      value: function render() {
        var style = core.Styler.getStyleFor(css_248z$2, {
          baseUrl: this.options.baseUrl
        });
        this.rendered = true;
  ...
  var SpinnerThreeBouncePlugin = /*#__PURE__*/function (_UIContainerPlugin) {
    ...
    _createClass(SpinnerThreeBouncePlugin, [{
      ...
      key: "render",
      value: function render() {
        var style = core.Styler.getStyleFor(css_248z$1, {
          baseUrl: this.options.baseUrl
        });
        this.$el.html(this.template());
        this.$el.append(style[0]);
