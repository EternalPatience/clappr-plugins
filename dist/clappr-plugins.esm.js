import { Events, Playback, Styler, UICorePlugin, template, CorePlugin, PlayerError, $, ContainerPlugin, Utils, Browser, UIContainerPlugin } from '@clappr/core';
...
var ClickToPausePlugin = /*#__PURE__*/function (_UICorePlugin) {
  ...
  _createClass(ClickToPausePlugin, [{
    ...
    value: function onTouch() {
      if (this.core.mediaControl.isVisible()) this.container.trigger(Events.CONTAINER_CLICK);else this.core.mediaControl.show();
    }
  }, {
    key: "pausable",
